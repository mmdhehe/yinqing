<!-- 资产采购申请表 -->
<template>
<div class="component-assetpurchase">
	<div class="title">资产采购申请表</div>
	...
	<table class='form-info' border="1" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td style="width: 25%">预估金额</td>
			<td style="width: 25%">用途<span class='right' @click='addline' v-if='IsBtn'><i class='el-icon-circle-plus-outline'></i></span></td>
		</tr>
	...
	<table class='form-info' border="1" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td style="width: 25%"><input type="text" :readonly="IsBtn ? false : 'readonly'"></td>
		...
		<tr>
			<td class='vertical'>总经理</td>
			<td><input type="text" :readonly="IsBtn ? false : 'readonly'"></td>
			<td class='vertical'>意见</td>
			<td class='vertical'><input type="text" :readonly="IsBtn ? false : 'readonly'"></td>
			<td class='vertical'>原因</td>
			<td><input type="text" :readonly="IsBtn ? false : 'readonly'"></td>
			<td class='vertical'>时间</td>
			<td><input type="text" :readonly="IsBtn ? false : 'readonly'"></td>
