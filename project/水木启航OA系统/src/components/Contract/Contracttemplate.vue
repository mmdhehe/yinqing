		...
		<div class="contractlist">
			...
			<div class="contract-content">
				<div class="content-title">
					...
					<p class='title-ContractTemplateName'>合同模板名称</p>
				...
				<div class="content-main" v-for='(item, index) in contractList' :key='index' :id='index'>
					...
					<!-- 合同模板名称 -->
					<div class="title-ContractTemplateName">
						<p>{{item.ContractTemplateName}}</p>
					</div>
					<!-- 上传人员 -->
...
export default {
	...
	data() {
		return {
			...
			value: 1,
			// 合同模板列表
			contractList: [{Serial: 1, ContractTemplateName: '塔院******合作项目', UploadStaff: '张华', UploadDate: '2019/2/14'}],
			// 要查看的数据
			forminfo: {}
		}
	},
	...
	.content {
		...
		.contractlist {
			...
			.contract-content {
				...
				.title-Serial { flex: 1; }
				.title-ContractTemplateName { flex: 3; }
